      ...
      <div className="anim_container">
        <div className="anim_text">
          ...
          <div className="hometext1">
            ...
            <p>
              At Expertia, we invite you to join us,<br></br>guide the curious
              minds,<br></br>and let your knowledge shine.<br></br>We believe
              that every experience you’ve gathered,<br></br>every lesson you’ve
              learned,<br></br>and every insight you’ve gained has the power to
              enlighten and inspire.<br></br>So come aboard, let’s embark on
              this journey of knowledge sharing together.<br></br>Your expertise
              can light the way for those eager to learn.<br></br>Join Expertia
              - where your wisdom shapes the future.
            </p>
          </div>
        </div>
        <div className="anim_text">
          ...
          <div className="hometext1">
            ...
            <p>
              ...
              threshold of a world full of possibilities. We’re here to ensure
              you navigate it with the wisdom of experienced experts from
              various fields.
              <br />
              “Experience the power of Expert Guidance, enjoy the confidence of
              a Trustworthy platform, and benefit from our Flexible Pricing at
              Expertise , your partner for professional growth.”
              <br /> Join us today and accelerate your professional growth with
              Expertise!
            </p>
          </div>
        </div>
