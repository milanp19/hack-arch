          ...
          >
            ...
            <div className="hometext2">
              ...
              <p>
                ...
                ensure you navigate it with the wisdom of experienced experts
                from various fields.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="hometext3">
              ...
              <p>
                ...
                young professionals, we offer priority access, exclusive
                webinars, personalized learning paths, and premium support.{" "}
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div>
            <p style={{ paddingBottom: "50px" }}>
              ...
              of expertise and has a wealth of knowledge and experience to
              share? If yes, then you will love our platform: <b>Expertia</b>,
              brings together retired experts from various fields, such as
              teachers, architects, doctors, financial experts, etc., to offer
              their wisdom, guidance, and services to individuals seeking
              assistance. <b>Expertia</b> connects you with experienced
              professionals who are eager to share their knowledge and expertise
              with upcoming young professionals in the corresponding fields.{" "}
              <b>Expertia</b> is more than just a platform; it’s a community of
              wisdom seekers and wisdom givers.
            </p>
          </div>
        </motion.section>
      </div>
